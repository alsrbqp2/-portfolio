...
<body>
<center>
<a href='login_index.jsp'><h1>Paichai Movie</h1></a>

<!-- 검색 창 -->
<table border=0>
<form action='search.jsp' method='post'>
<tr><td width='1000'></td>
<td><input type='text' name='search_msg'></td><td><input type='submit' value='검색'></td></tr>
</form>
</table>

<a class="btn" href="introduction.jsp">소개</a>
<a class="btn" href="MovieList.jsp">영화</a>
<a class="btn" href="review.jsp">리뷰게시판</a>
<a class="btn" href="mypage_process.jsp">마이페이지</a>
